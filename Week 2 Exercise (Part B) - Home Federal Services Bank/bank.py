...
# Kramer is instead greeted with a “hey,” which he insists isn’t a “hello,” and so he asks for $100. The bank’s manager proposes a
# compromise: “You got a greeting that starts with an ‘h,’ how does $20 sound?” Kramer accepts.
...
# Step 1: Input a greeting to the user
greeting = input("Greeting: ")

# Step 2: Conditional statements
if greeting.replace(" ", "").lower() == "hello" or greeting.replace(" ", "")[0:5].lower() == "hello":
    print("$0")
